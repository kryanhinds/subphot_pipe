...
class subtracted_phot(subphot_data):
    def __init__(self,ims,args):
        ...
        if len(self.ims)<1:
            print(warn_r+' Add image names without fits extension to run eg.:  python subphot_subtract_v1.py -i filename1 filename2')
            ##sys.exit(1)
            self.sys_exit=True
    ...
    def swarp_ref_align(self,image_size=image_size):
        ...
        # subphot_quicklook_pipe_v1.py for the same logic; this fixes the
        ...
        if _wcs_status != 0:
            ...
            print(info_g+' [V2] subphot_align_quick WCS update completed successfully')
