...
import argparse
from sedm_quicklook_pipe import *
from sedm_telescopes import header_kw,SEDM
...
parser.add_argument('--survey','-s',default='PS1',
...
parser.add_argument('--use_psfex','-psfex',action='store_false',default=False,
