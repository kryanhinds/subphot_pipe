...
class subtracted_phot(subphot_data):
    ...
    def make_sdss_ref(self,sdss_filt='u'):
        ...
        self.nx_range = range(-4,4)
        self.ny_range = range(-4,4)
    ...
    def swarp_ref_align(self,image_size=image_size):
        ...
        wcs_command='python3 '+self.opath+'subphot_align_quick.py'+" "+self.data1_path+'bkg_subtracted_science/'+self.sci_img_name+" "+self.ref_img_name+"  -m relative -r 60"
    ...
    def upload_phot(self):
        ...
        # if self.sci_obj=='AT2025bcw' or self.sci_obj=='2025bcw':self.mag_all_err/=2
        if self.sci_obj=='AT2025bcq':self.sci_obj='ZTF25aafiske'
        # if self.sci_obj=='AT2025bbo' and self.sci_filt == 'i':self.mag[0] = self.mag[0]-1
    ...
    def down_ref(self):
        if self.sci_filt == 'u' or self.use_sdss:
            ...
            try:
                ...
                print(info_g+' Reference image download status',panstamps_status)
            except Exception as e:
